CLASS zcl_gen_travel_data_kk DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_gen_travel_data_kk IMPLEMENTATION.
 METHOD if_oo_adt_classrun~main.
     DATA itab TYPE TABLE OF ztravel_kk.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_kk.

*   insert the new table entries
    INSERT ztravel_kk FROM TABLE @itab.
